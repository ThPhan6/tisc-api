...
describe("Product tip API ", () => {
      ...
      chai
        ...
        .end((_err, res) => {
          ...
          res.body.data.contents.map((item) => {
            item.should.have.keys("id", "title", "content");
          });
          done();
        });
    });
  ...
  describe("Update", () => {
    it("Incorrect id", (done) => {
      chai
        .request(HOST_URL)
        .put(`/product-tip/update/${productId}-123`)
        .set({ Authorization: `Bearer ${tiscAdminToken}` })
        .send({
          product_id: productId,
          contents: [
    ...
    it("Correct id", (done) => {
      chai
        .request(HOST_URL)
        .put(`/product-tip/update/${productId}`)
        .set({ Authorization: `Bearer ${tiscAdminToken}` })
        .send({
          product_id: productId,
          contents: [
  ...
  describe("Get one", () => {
    it("Incorrect id", (done) => {
      chai
        .request(HOST_URL)
        .get(`/product-tip/get-one/${productId}-123`)
        .set({ Authorization: `Bearer ${tiscAdminToken}` })
        .send({
          product_id: productId,
          contents: [
    ...
    it("Correct id", (done) => {
      chai
        .request(HOST_URL)
        .get(`/product-tip/get-one/${productId}`)
        .set({ Authorization: `Bearer ${tiscAdminToken}` })
        .send({
          product_id: productId,
          contents: [
