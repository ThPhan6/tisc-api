...
export default {
  create: {
    payload: {
      ...
      billing_amount: requireNumberValidation("Billing amount"),
      due_date: requireStringValidation("Due date"),
  ...
  update: {
    ...
    payload: {
      ...
      billing_amount: numberValidation(),
      due_date: stringValidation(),
