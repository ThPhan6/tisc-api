...
const permissionData = [
  {
    ...
    type: 1,
    routes: [
      ROUTES.GET_TISC_WORKSPACE,
      ROUTES.GET_TISC_WORKSPACE_SUMMARY,
    ...
    subs: [
      ...
      },
      {
        ...
        routes: [
          ...
          ROUTES.GET_STEPS,
          ROUTES.GET_LINKAGE_REST_OPTIONS,
        ],
        index: 10,
        id: "permission_3_3",
      },
...

  {
    ...
    type: 2,
    routes: [
      ROUTES.GET_BRAND_WORKSPACE,
      ROUTES.GET_BRAND_WORKSPACE_SUMMARY,
  ...
  },
  {
    ...
    routes: [
      ...
      ROUTES.PRE_SPECFICATION.UPDATE_USER_SPEC_SELECTION,
      ROUTES.GET_LIST_CATEGORY,
      ROUTES.VALIDATE_CONFIGURATION_STEP,
      ROUTES.GET_CONFIGURATION_STEPS,
      ROUTES.GET_STEPS,
    ],
  },
  {
...

  {
    ...
    routes: [
      ...
      ROUTES.SETTING.GET_COUNTRIES,
      ROUTES.GET_ONE_PROJECT,
      ROUTES.SETTING.GET_MEASUREMENT_UNIT,
      ROUTES.SETTING.COMMON_TYPES_LIST,
      ROUTES.SETTING.GET_STATES,
      ROUTES.SETTING.GET_CITIES,
  ...
  },
  {
    ...
    routes: [
      ...
      ROUTES.CUSTOM_PRODUCT.CREATE,
      ROUTES.CUSTOM_PRODUCT.UPDATE,
      ROUTES.CUSTOM_PRODUCT.GET_LIST,
      ROUTES.CUSTOM_PRODUCT.GET_ONE,
      ROUTES.CUSTOM_PRODUCT.DELETE,
      ROUTES.CUSTOM_PRODUCT.DUPLICATE,
      ROUTES.VALIDATE_CONFIGURATION_STEP,
      ROUTES.GET_CONFIGURATION_STEPS,
      ROUTES.GET_STEPS,
    ],
  },
  {
    ...
    subs: [
      ...
      },
      {
        ...
        index: 33,
        id: "permission_13_1",
        routes: [ROUTES.GET_ONE_PROJECT, ROUTES.UPDATE_PROJECT],
      },
      {
        logo: null,
        name: "Zone/Area/Room",
    ...
    subs: [
      {
        ...
        index: 38,
        id: "permission_14_0",
        routes: [ROUTES.DESIGN_FIRM.UPDATE_DESIGN_FIRM],
      },
      {
        logo: "/logo/location.svg",
        name: "Locations",
